...
function SongList() {
  ...
  return (
    <div
      id="SongList"
      className="flex flex-col h-[500px] max-w-2xl p-0 rounded-lg bg-white/5 border-white/10 backdrop-blur-xl shadow-xl hover:shadow-cyan-500/5 transition-all duration-300 overflow-y-auto scrollbar-hide"
    >
      {/* Sticky Header */}
