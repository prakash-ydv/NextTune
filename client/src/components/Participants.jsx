...
function Participants() {
  ...
  return (
    <div className="flex flex-col max-h-[500px] md:h-[500px] p-0 rounded-lg bg-white/5 border-white/10 backdrop-blur-xl shadow-xl hover:shadow-cyan-500/5 transition-all duration-300 overflow-hidden relative">
